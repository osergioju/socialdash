    ...
    <div style={{ minHeight: "100vh", background: C.bg, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'DM Sans', sans-serif", padding: 20 }}>
      <div style={{ width: "100%", maxWidth: 380 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 36 }}>
          ...
          <p style={{ margin: "6px 0 0", fontSize: 13, color: C.textMuted }}>Acesso ao seu painel de resultados</p>
        </div>

        <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 16, padding: 28 }}>
          <h2 style={{ margin: "0 0 22px", fontSize: 17, fontWeight: 700, color: C.text }}>Entrar</h2>
